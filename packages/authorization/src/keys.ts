...
export namespace AuthorizationBindings {
  export const AUTHORIZE_ACTION = BindingKey.create<AuthorizeFn>('sf.userAuthorization.actions.authorize');
  ...
  export const CONFIG = BindingKey.create<AuthorizationConfig>('sf.userAuthorization.config');
